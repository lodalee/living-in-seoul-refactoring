...
import com.gavoza.backend.domain.auth.dto.request.SocialAuthCodeRequestDto;
import com.gavoza.backend.domain.auth.dto.response.SocialLoginResponseDto;
import com.gavoza.backend.domain.auth.service.SocialSigninService;
import com.gavoza.backend.domain.auth.service.SocialTokenService;
